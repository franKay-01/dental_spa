...
export default function ImageSliderComprehensive({handleClose,  show}) {
  const showHideClassName = show ? "modal display-block" : "modal display-none";

  const importAll = (r) => r.keys().map(r);
  let images = importAll(require.context('../assets/comprehensive_product_catalogue', false, /\.(png|jpe?g|svg)$/));
