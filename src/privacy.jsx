...
export default function PrivacyPage(){
  ...
  const handleOpen = (value) => {
    console.log(open === value ? 0 : value)
          ...
          <div className='max-w-screen-sm lg:max-w-screen-lg md:max-w-screen-md gap-4'>
            ...
            <div className='grid grid-cols-1 gap-4 mt-8'>
              ...
              <Accordion className='' open={open === 1}>
                <AccordionHeader className='text-left accordion-border' onClick={() => handleOpen(1)}>
                  <h1 className='blog-title'>Scope of This Privacy Policy</h1>
                </AccordionHeader>
                {open === 1 && (
                  <AccordionBody className="accordion-body-bg">
                    <p>
                      ...
                      <ul className="bullet-ul">
                        ...
                        <li>
                          <span className="flex flex-col gap-2">All employees and job applicants or prospective employees of Transform-MDS.</span>
                        </li>
                        <li>
                          <span className="flex flex-col gap-2">All suppliers, partners, and service providers of Transform-MDS.</span>
                        </li>
                      </ul>
                    </p>
                  </AccordionBody>
              ...
              <Accordion className='' open={open === 2}>
                <AccordionHeader className='text-left accordion-border' onClick={() => handleOpen(2)}>
              ...
              <Accordion className='' open={open === 3}>
                <AccordionHeader className='text-left accordion-border' onClick={() => handleOpen(3)}>
              ...
              <Accordion className='' open={open === 4}>
                <AccordionHeader className='text-left accordion-border' onClick={() => handleOpen(4)}>
                  <h1 className='blog-title'>How We Protect Your Personal Information</h1>
                </AccordionHeader>
                {open === 4 && (
                  <AccordionBody className="accordion-body-bg">
                    <p>
                    Transform-MDS employs rigorous security measures to safeguard your data from unauthorized access, alteration, loss, disclosure, or destruction. However, internet communications (e.g., emails) are not entirely secure, and we cannot be responsible for external breaches.
                    </p>
                  </AccordionBody>
                )}
              </Accordion>
              <Accordion className='' open={open === 5}>
                <AccordionHeader className='text-left accordion-border' onClick={() => handleOpen(5)}>
              ...
              <Accordion className='' open={open === 6}>
                <AccordionHeader className='text-left accordion-border' onClick={() => handleOpen(6)}>
                  <h1 className='blog-title'>Data Retention</h1>
                </AccordionHeader>
                {open === 6 && (
                  <AccordionBody className="accordion-body-bg">
                    <p>
                    We retain your data only as long as necessary for lawful processing.
                    </p>
                  </AccordionBody>
                )}
              </Accordion>
              <Accordion className='' open={open === 7}>
                <AccordionHeader className='text-left accordion-border' onClick={() => handleOpen(7)}>
                  <h1 className='blog-title'>Your Privacy Rights</h1>
                </AccordionHeader>
                {open === 7 && (
                  <AccordionBody className="accordion-body-bg">
                    <p>
                    You can request access to your data or make corrections by contacting our Customer Care Service Team. You may also lodge complaints with the Data Protection Commission if your privacy rights are violated. You have the right to withdraw your consent, which may impact our ability to fulfil contractual obligations.
                    </p>
                  </AccordionBody>
                )}
              </Accordion>
              <Accordion className='' open={open === 8}>
                <AccordionHeader className='text-left accordion-border' onClick={() => handleOpen(8)}>
                  <h1 className='blog-title'>Changes To This Policy</h1>
                </AccordionHeader>
                {open === 8 && (
                  <AccordionBody className="accordion-body-bg">
                    <p>
                    This Privacy Policy is effective as of 1st June 2024. We may update it to reflect changes in our practices, legislation, or website enhancements. Material changes will be prominently communicated on our website.
                    </p>
                  </AccordionBody>
                )}
              </Accordion>
